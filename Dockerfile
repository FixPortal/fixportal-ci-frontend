...
# Every dependency resolves from public npm, so this build needs no registry
# credentials — anyone can build this image from a clone.
# --ignore-scripts: nothing in the tree needs a lifecycle script to build, so no
# third-party install code runs.
